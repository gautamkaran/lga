            ...
            <div className="bg-primary rounded-[2.5rem] p-12 text-center text-white relative overflow-hidden shadow-2xl shadow-primary/30">
                ...
                <div className="relative z-10 max-w-[720px] mx-auto space-y-8">
                    ...
                    <div className="flex justify-center">
                        <button className="bg-white text-primary h-14 px-10 rounded-xl text-lg font-black hover:bg-slate-100 transition-all transform hover:-translate-y-1 active:scale-95">
                            Start Free Session
                        </button>
                    </div>
                </div>
